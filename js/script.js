...
// CountDown
$('#event-date').countdown('2019/09/27', function(event) {
    var $this = $(this).html(event.strftime(''
        +'<div class="col-2 d-flex flex-column px-2 align-items-center py-2"><span>%w</span><span>Weeks</span></div>'
        +'<div class="col-2 d-flex flex-column px-2 align-items-center py-2"><span>%d</span><span>Days</span></div>'
        +'<div class="col-2 d-flex flex-column px-2 align-items-center py-2"><span>%H</span><span>Hr</span></div>'
        +'<div class="col-2 d-flex flex-column px-2 align-items-center py-2"><span>%M</span><span>Min</span></div>'
        +'<div class="col-2 d-flex flex-column px-2 align-items-center py-2"><span>%S</span><span>Sec</span></div>'    
        ));
});
